...
${OBJETIVO}   Preencher todos os campos da tela Histórico de Crachás para Veículos (Inclusão)

*** Test Cases ***

Testcase: Preencher todos os campos da tela Histórico de Crachás para Veículos (Inclusão)
