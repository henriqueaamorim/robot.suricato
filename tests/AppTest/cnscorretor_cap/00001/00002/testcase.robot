...
${OBJETIVO}   Preencher todos os campos da tela através da tela Seguros de Veículos - Atualização


*** Test Cases ***

Testcase: Preencher todos os campos da tela através da tela Seguros de Veículos - Atualização
