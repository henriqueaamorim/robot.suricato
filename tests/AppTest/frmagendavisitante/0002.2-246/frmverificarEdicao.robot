...
*** Variables ***
${SCREENNAME}  Agendamento de Visitas 
${APPNAME}     frmagendavisitante
${OBJETIVO}    Verificar todos os campos na tela Agendamento de Visita (Edição)


*** Test Cases ***
Testcase: Verificar todos os campos na tela Agendamento de Visita (Edição)
  [Tags]  VERIFY   246  247
