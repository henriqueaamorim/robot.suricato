...
Testcase: Acessar Tela Movimentação de Visitantes
  ...
  Então devo visualizar a tela: Movimentação de Visitantes
...
Então devo visualizar a tela: Movimentação de Visitantes
  resource_cnsMovimentacaoVisitantes.Acessar Tela Movimentação de Visitantes 
