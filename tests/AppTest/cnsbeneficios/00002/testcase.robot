...
${OBJETIVO}   Preencher todos os campos da Tela Consulta Benefícios (Busca Externa) através da tela Consulta Saldo de Benefícios nos Coletores

*** Test Cases ***

Testcase: Preencher todos os campos da Tela Consulta Benefícios (Busca Externa) através da tela Consulta Saldo de Benefícios nos Coletores
  ...
  E preencher o campo Código do Benefício 
...
E preencher o campo Código do Benefício "${CÓDIGO_DO_BENEFÍCIO}"
  resource_cnsbeneficios.Preencher o campo Código do Benefício "${CÓDIGO_DO_BENEFÍCIO}"

E preencher o campo Descrição"${DESCRIÇÃ}"
  resource_cnsbeneficios.Preencher o campo Descrição"${DESCRIÇÃ}"
