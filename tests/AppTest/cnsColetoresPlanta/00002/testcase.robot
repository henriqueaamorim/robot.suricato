...
${OBJETIVO}   Preencher todos os campos da tela Consulta de Codins (Busca Externa) através da tela Consulta de Reações de Acesso

*** Test Cases ***

Testcase: Preencher todos os campos da tela Consulta de Codins (Busca Externa) através da tela Consulta de Reações de Acesso
  ...
  E preencher o campo Descrição do Codin "ok"
...
E preencher o campo Descrição do Codin "${DESCRIÇÃO_DO_CODIN}"
  resource_cnsColetoresPlanta.Preencher o campo Descrição do Codin "${DESCRIÇÃO_DO_CODIN}"
