...
Resource        ../../../../resource/app/resource_consgrupovisitantecorp.robot
...
Testcase: Acessar Tela Consulta de Grupo de Visitante (Busca Externa) através da tela Entrada de Grupo (Consulta)
  ...
  Ao clicar no botão: Buscar Dados Externos Para Grupo de Visitante
  Então o navegador deve exibir uma nova janela e eu visualizar a tela Consulta de Grupo de Visitante (Busca Externa)
...
Ao clicar no botão: Buscar Dados Externos para Grupo de Visitante
  resource_ctrentradagrupo.Clicar No Botão Buscar Dados Externos Para Grupo de Visitante

Então o navegador deve exibir uma nova janela e eu visualizar a tela Consulta de Grupo de Visitante (Busca Externa)
  resource_consgrupovisitantecorp.Acessar Tela Consulta de Grupo de Visitante (Busca Externa)
