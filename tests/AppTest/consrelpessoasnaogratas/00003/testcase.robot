...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelpessoasnaogratas.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelpessoasnaogratas.Verificar a label Pesquisa

E verificar o campo Exibir Usuário:
  resource_consrelpessoasnaogratas.Verificar o campo Exibir Usuário:
