...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelcadastrovisitantes.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelcadastrovisitantes.Verificar a label Pesquisa

E verificar o campo Tipo
  resource_consrelcadastrovisitantes.Verificar o campo Tipo

E verificar o campo Número
  resource_consrelcadastrovisitantes.Verificar o campo Número

E verificar o campo Exibir Usuário:
  resource_consrelcadastrovisitantes.Verificar o campo Exibir Usuário:
