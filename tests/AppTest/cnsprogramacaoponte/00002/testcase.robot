...
${SCREENNAME}  Consulta de Pontes
${APPNAME}     cnsprogramacaoponte
${OBJETIVO}    Verificar todos os campos na tela Consulta de Pontes.

*** Test Cases ***

Testcase: Verificar todos os campos na tela Consulta de Pontes
  [Tags]  VERIFY
...
E verificar a label Data Inicial
  resource_cnsprogramacaoponte.Verificar a label Data Inicial

E verificar a label Data Final
  resource_cnsprogramacaoponte.Verificar a label Data Final
