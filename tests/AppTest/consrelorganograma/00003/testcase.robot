...
Testcase: Verificar todos os campos na tela Valores de Entrada do Modelo
  ...
  E verificar o campo Mostrar Usuário:
...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelorganograma.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelorganograma.Verificar a label Pesquisa

E verificar o campo Mostrar Usuário:
  resource_consrelorganograma.Verificar o campo Mostrar Usuário:

E verificar o campo Organograma
  resource_consrelorganograma.Verificar o campo Organograma

E verificar o campo Local
  resource_consrelorganograma.Verificar o campo Local
