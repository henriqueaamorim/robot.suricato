...
${SCREENNAME}  Agendamento do Uso da Frota (Inclusão)
${APPNAME}     frmagendusofrota
${OBJETIVO}    Verificar todos os campos na tela Agendamento do Uso da Frota (Inclusão)


*** Test Cases ***

Testcase: Verificar todos os campos na tela Agendamento do Uso da Frota (Inclusão)
  [Tags]  VERIFY
