...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelcargos.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelcargos.Verificar a label Pesquisa

E verificar o campo Código do Cargo
  resource_consrelcargos.Verificar o campo Código do Cargo

E verificar o campo Exibir Usuário:
  resource_consrelcargos.Verificar o campo Exibir Usuário:
