...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelcoletores1.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelcoletores1.Verificar a label Pesquisa

E verificar o campo Exibir Usuário:
  resource_consrelcoletores1.Verificar o campo Exibir Usuário:
