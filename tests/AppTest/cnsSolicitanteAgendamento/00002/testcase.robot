...
Testcase: Acessar Tela Solicitações e Aprovações de Agendamentos de Visitantes
  ...
  Então devo visualizar a tela: Solicitações e Aprovações de Agendamentos de Visitantes
...
Então devo visualizar a tela: Solicitações e Aprovações de Agendamentos de Visitantes
  resource_cnsSolicitanteAgendamento.Acessar Tela Solicitações e Aprovações de Agendamentos de Visitantes
