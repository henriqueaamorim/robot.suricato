...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelgrupopermissoes.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelgrupopermissoes.Verificar a label Pesquisa

E verificar o campo Exibir Usuário:
  resource_consrelgrupopermissoes.Verificar o campo Exibir Usuário:
