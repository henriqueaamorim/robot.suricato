...
*** Test Cases ***
Testcase: Acessar Tela Colaborador Responsável (Busca Externa) através da tela Cadastro de Responsáveis por Veículo
  ...
  Então eu devo visualizar a tela: Colaborador Responsável (Busca Externa)
...
Então eu devo visualizar a tela: Colaborador Responsável (Busca Externa)
  resource_cnsresponsaterceiro.Acessar Tela Colaborador Responsável (Busca Externa)
