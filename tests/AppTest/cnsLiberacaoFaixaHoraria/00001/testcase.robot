...
Testcase: Acessar Tela Relatório de Liberação de Faixa Horária - Filtro
  ...
  Ao digitar a descrição: "Relatório de Liberação de Faixa Horária", e clicar em Pesquisar
