...
*** Variables ***
${OBJETIVO}    Verificar todos os campos na tela: Área de Risco - Painel de Controle (Filtro)
${SCREENNAME}  Painel de Controle
${APPNAME}     cons_tbContrLocalAcesso


*** Test Cases ***
Testcase: Verificar todos os campos na tela: Área de Risco - Painel de Controle (Filtro)
...
Então devo visualizar a tela: Área de Risco - Painel de Controle (Filtro)
  resource_cons_tbContrLocalAcesso.Acessar Tela Área de Risco - Painel de Controle - Filtro

E verificar o campo Área de Risco
    resource_cons_tbContrLocalAcesso.Verificar o campo Área de Risco

E verificar o campo Nome
    resource_cons_tbContrLocalAcesso.Verificar o campo Nome 

E verificar o campo Matricula  
    resource_cons_tbContrLocalAcesso.Verificar o campo Matricula
