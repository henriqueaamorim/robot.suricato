...
*** Variables ***
${OBJETIVO}   Preencher todos os campos na tela AFD - Empresa.

*** Test Cases ***
Testcase: Preencher todos os campos na tela AFD - Empresa
  ...
  E selecionar uma opção no campo Planta "Alfandega"
...
E selecionar uma opção no campo Empresa "${EMPRESA}"
  resource_ctr_rep_coleta_afd.Selecionar uma opção no campo Empresa "${EMPRESA}"

E selecionar uma opção no campo Planta "${PLANTA}"
  resource_ctr_rep_coleta_afd.Selecionar uma opção no campo Planta "${PLANTA}"
