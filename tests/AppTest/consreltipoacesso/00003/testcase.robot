...
Testcase: Verificar todos os campos na tela Valores de Entrada do Modelo
  ...
  E verificar o campo Código do Tipo de Acesso
...
E verificar a label Pesquisa
  resource_consreltipoacesso.Verificar a label Pesquisa

E verificar o campo Código do Tipo de Acesso
  resource_consreltipoacesso.Verificar o campo Código do Tipo de Acesso

E verificar o campo Exibir Usuário:
  resource_consreltipoacesso.Verificar o campo Exibir Usuário:
