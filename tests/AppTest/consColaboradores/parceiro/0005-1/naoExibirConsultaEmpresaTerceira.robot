...
*** Variables ***
${OBJETIVO}   Não exibir consulta de “Empresa Terceira” apenas para tipo de colaborador Terceiro


*** Test Cases ***
Testcase: Não exibir consulta de “Empresa Terceira” apenas para tipo de colaborador Terceiro
