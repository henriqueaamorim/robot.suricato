...
*** Test Cases ***
Testcase: Acessar Tela Comandos de Acesso On-Line - Horário de Verão
  ...
  Ao selecionar a checkbox "Horário de Verão", então devo visualizar as opções de tipos de comando
