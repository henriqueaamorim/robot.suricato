...
*** Test Cases ***
Testcase: Acessar Tela Comandos de Acesso On-Line - Modo de Acesso
  ...
  Ao selecionar a checkbox "Modo de Acesso", então devo visualizar as opções de tipos de comando
