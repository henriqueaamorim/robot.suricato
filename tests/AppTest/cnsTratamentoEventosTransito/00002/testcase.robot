...
Testcase: Acessar Tela Relatório de Tratamento de Eventos de Trânsito
  ...
  Então devo visualizar a tela: Relatório de Tratamento de Eventos de Trânsito
...
Então devo visualizar a tela: Relatório de Tratamento de Eventos de Trânsito
  resource_cnsTratamentoEventosTransito.Acessar Tela Relatório de Tratamento de Eventos de Trânsito
