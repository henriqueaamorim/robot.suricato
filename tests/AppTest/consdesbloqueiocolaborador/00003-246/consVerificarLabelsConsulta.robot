...
Então devo verificar a label: Empresa
    resource_consdesbloqueiocolaborador.Verificar a label: Empresa

E verificar a label: Tipo de Colaborador
    resource_consdesbloqueiocolaborador.Verificar a label: Tipo de Colaborador

E verificar a label: Matrícula
    resource_consdesbloqueiocolaborador.Verificar a label: Matrícula

E verificar a label: Data do Bloqueio
    resource_consdesbloqueiocolaborador.Verificar a label: Data do Bloqueio

E verificar a label: Hora do Bloqueio
    resource_consdesbloqueiocolaborador.Verificar a label: Hora do Bloqueio

E verificar a label: Motivo do Bloqueio
    resource_consdesbloqueiocolaborador.Verificar a label: Motivo do Bloqueio
