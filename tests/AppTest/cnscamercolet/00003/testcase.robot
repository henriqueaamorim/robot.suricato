...
Testcase: Acessar Tela Câmeras X Coletores
  ...
  E selecionar uma opção no campo Planta * "10 - ABA"
  E selecionar uma opção no campo Codin * "1 - REP - ABA"
...
E selecionar uma opção no campo Planta * "${PLANTA_*}"
  resource_cnscamercolet.Selecionar uma opção no campo Planta * "${PLANTA_*}"

E selecionar uma opção no campo Codin * "${CODIN_*}"
  resource_cnscamercolet.Selecionar uma opção no campo Codin * "${CODIN_*}"
