...
Testcase: Acessar Tela Provisório em Aberto
  ...
  Então devo visualizar a tela: Provisório em Aberto
*** Keywords ***
Dado que eu acesse o menu: Relatórios | Consulta Impressa
...
Então devo visualizar a tela: Provisório em Aberto
  resource_consrelcrachaentregueprov.Acessar Tela Provisório em Aberto
