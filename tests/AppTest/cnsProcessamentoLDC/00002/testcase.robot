...
Testcase: Acessar Tela Consulta Processamento LDC
  ...
  Então devo visualizar a tela: Consulta Processamento LDC
*** Keywords ***
Dado que eu acesse o menu: Relatórios | Consulta Impressa
...
Então devo visualizar a tela: Consulta Processamento LDC
  resource_cnsProcessamentoLDC.Acessar Tela Consulta Processamento LDC
