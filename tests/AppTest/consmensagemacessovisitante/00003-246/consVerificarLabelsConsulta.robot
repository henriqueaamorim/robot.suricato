...
*** Variables ***
${OBJETIVO}   Verificar todas as labels na Tela:  Mensagem de Acesso do Visitante (Consulta)

*** Test Cases ***
Testcase: Verificar todas as labels na Tela: Mensagem de Acesso do Visitante (Consulta)
