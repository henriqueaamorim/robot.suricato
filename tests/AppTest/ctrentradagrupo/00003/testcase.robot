...
${SCREENNAME}  Entrada de Grupo de Visitante
${APPNAME}     ctrentradagrupo
${OBJETIVO}    Verificar todos os campos na tela Entrada de Grupo de Visitante


*** Test Cases ***

Testcase: Verificar todos os campos na tela Entrada de Grupo de Visitante
  [Tags]  VERIFY
