...
Resource    ../../cnsMateriais_cap/00001/testcase.robot
...
E preencher o campo Código do Colaborador "${CÓDIGO_DO_COLABORADOR}"
  resource_cnsacessorios_cap.Preencher o campo Código do Colaborador "${CÓDIGO_DO_COLABORADOR}"

E preencher o campo Descrição "${DESCRIÇÃO}"
  resource_cnsacessorios_cap.Preencher o campo Descrição "${DESCRIÇÃO}"
