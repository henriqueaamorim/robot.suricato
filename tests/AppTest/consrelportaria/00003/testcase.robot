...
Então devo visualizar a tela: Valores de Entrada do Modelo
  resource_consrelportaria.Acessar Tela Valores de Entrada do Modelo

E verificar a label Pesquisa
  resource_consrelportaria.Verificar a label Pesquisa

E verificar o campo Exibir Usuário:
  resource_consrelportaria.Verificar o campo Exibir Usuário:
