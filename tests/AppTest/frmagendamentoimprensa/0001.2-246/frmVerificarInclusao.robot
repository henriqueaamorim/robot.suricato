...
${OBJETIVO}    Verificar todos os campos na tela Agendamento de Candidato (Inclusão)


*** Test Cases ***
Testcase: Verificar todos os campos na tela Agendamento de Candidato (Inclusão)
  [Tags]  VERIFY  246  247
