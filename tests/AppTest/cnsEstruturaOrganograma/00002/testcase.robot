...
Testcase: Acessar Tela Consulta de Estrutura de Organograma (Busca Externa) através da tela Autorização de Acesso Candidato (Inclusão)
  ...
  E preencher o campo Usa Máscara "ok"
...
E preencher o campo Tabela de Organograma "${TABELA_DE_ORGANOGRAMA}"
  resource_cnsEstruturaOrganograma.Preencher o campo Tabela de Organograma "${TABELA_DE_ORGANOGRAMA}"

E preencher o campo Descrição do Organograma "${DESCRIÇÃO_DO_ORGANOGRAMA}"
  resource_cnsEstruturaOrganograma.Preencher o campo Descrição do Organograma "${DESCRIÇÃO_DO_ORGANOGRAMA}"

E preencher o campo Usa Máscara "${USA_MÁSCARA}"
  resource_cnsEstruturaOrganograma.Preencher o campo Usa Máscara "${USA_MÁSCARA}"
