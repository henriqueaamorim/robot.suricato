...
Testcase: Verificar todos os campos na tela Valores de Entrada do Modelo
  ...
  E verificar o campo Código Empresa
...
E verificar a label Pesquisa
  resource_consreloutrasempresas.Verificar a label Pesquisa

E verificar o campo Código Empresa
  resource_consreloutrasempresas.Verificar o campo Código Empresa

E verificar o campo Exibir Usuário:
  resource_consreloutrasempresas.Verificar o campo Exibir Usuário:
