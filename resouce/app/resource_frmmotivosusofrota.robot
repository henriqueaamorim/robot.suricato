...
# SCREEN
Acessar Tela Motivos de Uso da Frota (Atualização)
  ${OBJ}         Set Variable  SCN
  ${SCREENNAME}  Set Variable  Motivos de Uso da Frota (Atualização)
  ${APPNAME}     Set Variable  frmmotivosusofrota
...
Acessar Tela Motivos de Uso da Frota (Inclusão)
  ${OBJ}         Set Variable  SCN
  ${SCREENNAME}  Set Variable  Motivos de Uso da Frota (Inclusão)
  ${APPNAME}     Set Variable  frmmotivosusofrota
...
Preencher o campo Descrição "${DESCRICAO}"
  Input Text  xpath=//*[@name="desctipousoc"][@type="text"]  ${DESCRICAO}

Selecionar uma opção no campo Tipo do Uso "${TIPO}"
  Select from list by label  xpath=//*[@name="tipouso"]  ${TIPO}
...
Verificar o campo Tipo do Uso *
	...
	Element Should Contain  ${LABEL}   Tipo do Uso *
 	Element Attribute Value Should Be  ${CAMPO}   name   tipouso
...
Verificar o campo Tipo do Uso * (Inclusão)
	${LABEL}   Set Variable  xpath=/html/body/form[4]/table/tbody/tr[3]/td/table/tbody/tr/td/div/table/tbody/tr[2]/td[1]
