...
# SCREEN
Acessar Tela: Baixa Autorização Entrada (Consulta)
  ${OBJ}         Set Variable  SCN
  ${APPNAME}  Set Variable  cnsBaixaCracha
  IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
  ${SCREENNAME}  Set Variable    Baixa Autorização Entrada
  ${ELEMENT}     Set Variable    xpath=//td[contains(text(),'${SCREENNAME}')]
  ELSE
  ${SCREENNAME}  Set Variable  Consulta de Baixa Autorização Entrada
...
Acessar Tela: Baixa Autorização Entrada (Filtro)
  ${OBJ}         Set Variable  SCN
  ${APPNAME}  Set Variable  cnsBaixaCracha
  IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
  ${SCREENNAME}  Set Variable    Baixa Autorização Entrada
  ${ELEMENT}     Set Variable    xpath=//td[contains(text(),'${SCREENNAME} ')]
  ELSE 
  ${SCREENNAME}  Set Variable    Consulta de Baixa Autorização Entrada (Filtro)
...
Verificar a label Data de Saída
	IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
		${LABEL}   Set Variable  xpath=//div[contains(text(),'Data de Saída')]
	ELSE	
...
Verificar o campo Data de Entrada
	IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
		...
		${CAMPO1}  	  Set Variable  xpath=//input[@name='tbentracolab_dataentr_dia']
		${CAMPO2}  	  Set Variable  xpath=//input[@name='tbentracolab_dataentr_mes']
		${CAMPO3}  	  Set Variable  xpath=//input[@name='tbentracolab_dataentr_ano']
		${CAMPO4}  	  Set Variable  xpath=//input[@name='tbentracolab_dataentr_input_2_dia']
		${CAMPO5}  	  Set Variable  xpath=//input[@name='tbentracolab_dataentr_input_2_mes']
		${CAMPO6}  	  Set Variable  xpath=//input[@name='tbentracolab_dataentr_input_2_ano']

 	Element Attribute Value Should Be  ${CAMPO1}   name   tbentracolab_dataentr_dia
	Element Attribute Value Should Be  ${CAMPO2}   name   tbentracolab_dataentr_mes
	Element Attribute Value Should Be  ${CAMPO3}   name   tbentracolab_dataentr_ano
	Element Attribute Value Should Be  ${CAMPO4}   name   tbentracolab_dataentr_input_2_dia		
	Element Attribute Value Should Be  ${CAMPO5}   name   tbentracolab_dataentr_input_2_mes
	Element Attribute Value Should Be  ${CAMPO6}   name   tbentracolab_dataentr_input_2_ano
...
Verificar o campo Hora de Entrada
	IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
		...
		${CAMPO1}  	  Set Variable  xpath=//input[@name='tbentracolab_horaentr_hor']
		${CAMPO2}  	  Set Variable  xpath=//input[@name='tbentracolab_horaentr_min']
		${CAMPO3}  	  Set Variable  xpath=//input[@name='tbentracolab_horaentr_input_2_hor']
		${CAMPO4}  	  Set Variable  xpath=//input[@name='tbentracolab_horaentr_input_2_min']
    
	Element Attribute Value Should Be  ${CAMPO1}   name   tbentracolab_horaentr_hor
	Element Attribute Value Should Be  ${CAMPO2}   name   tbentracolab_horaentr_min
	Element Attribute Value Should Be  ${CAMPO3}   name   tbentracolab_horaentr_input_2_hor	
	Element Attribute Value Should Be  ${CAMPO4}   name   tbentracolab_horaentr_input_2_min
...
Verificar o campo Crachá
	IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
		...
		${CAMPO}  	  Set Variable  xpath=//input[@name='tbentracolab_icard']
	ELSE
		${LABEL}      Set Variable  xpath=/html/body/form[3]/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[7]/td[1]
		${CAMPO}  	  Set Variable  xpath=/html/body/form[3]/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[7]/td[3]/table/tbody/tr/td/input
		${CAMPO1}  	  Set Variable  xpath=/html/body/form[3]/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[7]/td[2]/select
		
	Element Attribute Value Should Be  ${CAMPO1}   name   tbentracolab_icard_cond
	END
	Element Should Contain  ${LABEL}   Crachá	
	Element Attribute Value Should Be  ${CAMPO}   name   tbentracolab_icard
...
Selecionar uma opção no campo Matrícula "${MATRÍCULA}"
	Select From List By Label  xpath=//*[@name="tbcolab_codimatr_cond"]  ${MATRÍCULA}

Preencher o campo Matrícula "${MATRÍCULA}"
	Input Text  xpath=//*[@name="tbcolab_codimatr"][@type="text"]  ${MATRÍCULA}

Selecionar uma opção no campo Data de Entrada "${DATA_DE_ENTRADA}"
	Select From List By Label  xpath=//*[@name="tbentracolab_dataentr_cond"]  ${DATA_DE_ENTRADA}
...
Selecionar uma opção no campo Hora de Entrada "${HORA_DE_ENTRADA}"
	Select From List By Label  xpath=//*[@name="tbentracolab_horaentr_cond"]  ${HORA_DE_ENTRADA}
...
Selecionar uma opção no campo Crachá "${CRACHÁ}"
	Select From List By Label  xpath=//*[@name="tbentracolab_icard_cond"]  ${CRACHÁ}

Preencher o campo Crachá "${CRACHÁ}"
	Input Text  xpath=//*[@name="tbentracolab_icard"][@type="text"]  ${CRACHÁ}
