...
# SCREEN
Acessar Tela Consulta de Grupo de REP
  ${OBJ}         Set Variable  SCN
  IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
      ${SCREENNAME}  Set Variable  Grupo de REP
  ELSE
      ${SCREENNAME}  Set Variable  Consulta de Grupo de REP
  END
  ${APPNAME}  Set Variable  cnsGrupoREP
...
Acessar Tela Grupo de REP (Filtro)
  ${OBJ}         Set Variable  SCN
  ${SCREENNAME}  Set Variable  Grupo de REP
  ${APPNAME}  Set Variable  cnsGrupoREP
  ${ELEMENT}  Set Variable    xpath=(//*[contains(text(),'${SCREENNAME}')])[2]
...
Verificar o campo Nome
	${LABEL}      Set Variable  xpath=//td[@id='SC_gruprepnome_label']
	${CAMPO}      Set Variable  xpath=//input[@name='gruprepnome']
