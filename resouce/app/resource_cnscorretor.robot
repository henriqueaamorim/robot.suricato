...
# SCREEN
Acessar Tela Consulta Corretor
  ${OBJ}         Set Variable  SCN
  
  ${APPNAME}     Set Variable  cnscorretor
  IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
    ${SCREENNAME}  Set Variable  Corretor
    ${ELEMENT}     Set Variable  xpath=//td[contains(text(),'${SCREENNAME}')]
  ELSE  
    ${SCREENNAME}  Set Variable  Consulta Corretor
...
#FIELD
Preencher o campo Código "${NUM}"
  Input Text  xpath=//*[@name="tbcorresegur_idcorr"][@type="text"]  ${NUM}
...
Verificar o campo: Código 
	...
	${CAMPO}      Set Variable  xpath=//input[@name='tbcorresegur_idcorr']
	Element Should Contain             ${LABEL}   Código
 	Element Attribute Value Should Be  ${CAMPO}   name  tbcorresegur_idcorr
