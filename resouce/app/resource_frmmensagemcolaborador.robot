...
Acessar Tela Mensagem de Acesso (Atualização)
  ...
  ${APPNAME}  Set Variable  frmmensagemcolaborador
  ${ELEMENT}  Set Variable    xpath=(//*[contains(text(),'${SCREENNAME}')])[2]

  Mudar Frame Aplicação "mnu_iframe"
  Mudar Frame Aplicação "nmsc_iframe_frmmensagemcolaborador_1"
...
Preencher o campo Hora do Término da Mensagem "${HORA}"
