...
# SCREEN
Acessar Tela Consulta de Grupo De Cameras
  ${OBJ}         Set Variable  SCN
  IF  "${SERVER}" == "172.16.14.246" or "${SERVER}" == "172.16.14.247" or "${SERVER}" == "26.120.163.33" or "${SERVER}" == "26.233.65.244"
      ${SCREENNAME}  Set Variable  Grupo De Camera
  ELSE
    ${SCREENNAME}  Set Variable  Consulta de Grupo De Cameras
  END
  ${APPNAME}     Set Variable  cnsGrupoCamera
...
Acessar Tela Grupo de Camera (Filtro)
  ${OBJ}         Set Variable  SCN
  ${SCREENNAME}  Set Variable  Grupo De Camera (Filtro)
  ${APPNAME}     Set Variable  cnsGrupoCamera
  ${ELEMENT}     Set Variable  xpath=//td[contains(text(),'Grupo De Camera (Filtro)')]
...
Preencher o campo Código "${COD}"
  Input Text   xpath=//*[@name="codigrupcame"][@type="text"]   ${COD}
...
Verificar o campo Código
	...
	${CAMPO}      Set Variable  xpath=//input[@name='codigrupcame']
...
Verificar o campo Descrição
	...
	${CAMPO}      Set Variable  xpath=//input[@name='descgrupcame']
